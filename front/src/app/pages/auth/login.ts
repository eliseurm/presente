                ...
                <div
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20"
                        ...
                        <div class="text-center mb-8">
                            ...
                            <div
                                class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">{{ 'login.welcome' | lang }}
                            </div>
                        ...
                        <form (ngSubmit)="signIn()" autocomplete="on">
                            <label for="email1"
                                   class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">{{ 'login.email' | lang }}</label>
                            <input
                                pInputText
                                id="email1"
                                type="email"
                            ...
                            <label for="password1"
                                   class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">{{ 'login.password' | lang }}</label>
                            <p-password
                                id="password1"
                                [(ngModel)]="password"
                                name="password"
                            ...
                            <div class="flex items-center justify-between mt-2 mb-4 gap-8">
                                <div class="flex items-center">
                                    <p-checkbox [(ngModel)]="checked" id="rememberme1" name="rememberMe" binary
                                                class="mr-2"></p-checkbox>
                                    <label for="rememberme1">{{ 'login.rememberMe' | lang }}</label>
                                </div>
                                <span
                                    class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">{{ 'login.forgotPassword' | lang }}</span>
                            </div>

                            @if (error) {
                                <small class="text-red-500 block mb-4">{{ error }}</small>
                            }
                            <p-button
