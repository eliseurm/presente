...
//     selector: 'app-login',
//     standalone: true,
//     imports: [ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule, AppFloatingConfigurator, LangPipe, LanguageSelectComponent],
//     template: `
//         <app-floating-configurator />
//         <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-screen overflow-hidden">
//             <div class="flex flex-col items-center justify-center">
...
//                         <div>
//                             <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">{{ 'login.email' | lang }}</label>
//                             <input pInputText id="email1" type="text" [placeholder]="'login.emailPlaceholder' | lang" class="w-full md:w-120 mb-8" [(ngModel)]="email" />
//
//                             <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">{{ 'login.password' | lang }}</label>
//                             <p-password id="password1" [(ngModel)]="password" [placeholder]="'login.passwordPlaceholder' | lang" [toggleMask]="true" styleClass="mb-4" [fluid]="true" [feedback]="false"></p-password>
//
...
//                                 <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">{{ 'login.forgotPassword' | lang }}</span>
//                             </div>
//                             <p-button [label]="'login.signIn' | lang" styleClass="w-full" routerLink="/"></p-button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
