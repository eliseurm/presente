...
<!--                </svg>-->
                ...
                <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title">
                    ...
                    <!-- FOLHA BASE (será replicada ao redor do círculo) -->
                    <defs>
                        <!-- Folha pequena posicionada no topo; o centro geométrico do selo é (27,20) -->
                        <path id="leaf" d="M27 7.5c.95 0 1.95.33 2.23 1.15c-.33 1.07-1.63 2.12-2.23 2.32c-.6-.2-1.9-1.25-2.23-2.32C25.05 7.83 26.05 7.5 27 7.5Z" fill="var(--primary-color)"/>
                    </defs>

                    <!-- COROA DE LOUROS (24 folhas ao redor) -->
                    <g>
                    ...
                    <!-- TEXTO CENTRAL (usa a mesma cor do ícone) -->
                    <g fill="var(--primary-color)" text-anchor="middle">
                        <!-- Linha 1: Señorita (serif/bold) -->
                        <text x="27" y="18.2" font-size="5" font-weight="700" font-family="Georgia, 'Times New Roman', serif">Señorita</text>
                        <!-- Linha 2: Brasil (cursiva) -->
                        <text x="27" y="24.8" font-size="6" font-family="'Brush Script MT', 'Segoe Script', cursive">Brasil</text>
                    </g>
                </svg>
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                ...
                <!-- Language switcher ao lado do ícone de cores -->
